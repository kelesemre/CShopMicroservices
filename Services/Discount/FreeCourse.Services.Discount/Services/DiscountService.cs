...
namespace FreeCourse.Services.Discount.Services
{
    public class DiscountService : IDiscountService
    {
        ...
        public async Task<Response<NoContent>> Delete(int id)
        {
            ...
            return status > 0 ? Response<NoContent>.Success(204) : Response<NoContent>.Fail("Dicount not found",404);
        }
        ...
        {
            var discounts = await _dbConnection.QueryAsync<Models.Discount>("select * from discount where code=@Code, userId = @UserId", new { Code = code, UserId = userId });
        ...
        public async Task<Response<NoContent>> Save(Models.Discount discount)
        {
            ...
            return Response<NoContent>.Fail("an error occurred while transaction", 500);
        }
